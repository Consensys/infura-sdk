...
export default class ERC721Mintable {
  ...
  async addAdmin(address) {
    ...
    try {
      return await this.#contractDeployed.grantRole(this.ADMIN_ROLE, address);
    } catch (error) {
  ...
  async removeAdmin(address) {
    ...
    try {
      return await this.#contractDeployed.revokeRole(this.ADMIN_ROLE, address);
    } catch (error) {
  ...
  async renounceAdmin(address) {
    ...
    try {
      return await this.#contractDeployed.renounceRole(this.ADMIN_ROLE, address);
    } catch (error) {
