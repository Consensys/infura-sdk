import { NFTContractUnlimited } from './nftcontractunlimited.contract.js';
import { TEMPLATES } from './templates.js';
import { validateEthereumAddress } from '../../Validation/validators.js';
...
export class BaseContract {
  ...
  getAddress() {
    if (!this._address) {
      throw new Exception(
        'Contract address not available. Either deploy a new contract or retrieve from existing address',
      );
    }
